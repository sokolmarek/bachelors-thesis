...
% \begin{figure}[h]
% 	\begin{center}
% 		\textcolor{cyan}{\fboxrule=0.5pt\fboxsep=0pt\fbox{\includegraphics[width=1\textwidth]{../assets/matlab_EDA/tab1}}}
...
% \begin{figure}[h]
% 	\begin{center}
% 		\textcolor{cyan}{\fboxrule=0.5pt\fboxsep=0pt\fbox{\includegraphics[width=1\textwidth]{../assets/matlab_EDA/tab2}}}
...
% \begin{figure}[h]
% 	\begin{center}
% 		\textcolor{cyan}{\fboxrule=0.5pt\fboxsep=0pt\fbox{\includegraphics[width=1\textwidth]{../assets/matlab_EDA/tab3}}}
