Kapitola výsledky je rozdělena na čtyři části. První dvě podkapitoly prezentují
...
\subsection{Analýza EKG záznamu pomocí Poincarého grafu}
...
realizované srovnání mezi případy N a S. Pro srovnání byl použit parametrický párový t-test (viz
...
\begin{table}[h]
	...
	\catcode`\-=12
	\begin{center}
		\caption{\label{tab:t_tests} Výsledky parametrických testů shody sledovaných veličin mezi klidovou částí (N) měření a při Stroopově testu (S) ($n=5$)}
		\vspace{1ex}
...
\begin{figure}[H]
	...
	\begin{subfigure}[b]{0.3\textwidth}
		\centering
		\includegraphics[width=1\linewidth]{figures/results_sd1}
		\caption{hodnoty SD1}
	...
	\begin{subfigure}[b]{0.3\textwidth}
		\centering
		\includegraphics[width=1\linewidth]{figures/results_sd2}
		\caption{hodnoty SD2}
	...
	\begin{subfigure}[b]{0.3\textwidth}
		\centering
		\includegraphics[width=1\linewidth]{figures/results_sd1sd2}
