Jedním z hlavních výsledků práce je realizace MATLAB SW řešení pro
...
bylo možné získat nadhled nad drtivou většinou open-source MATLAB
aplikací či pouhých skriptů. To vyplývá i z faktu, že mnoho současných řešení je
zastaralých a nové nepřibývají. Jedním z důvodu může být prudce vzrůstající
popularita prostředí Python, které v mnoha případech čím dál častěji
nahrazuje MATLAB realizace.
