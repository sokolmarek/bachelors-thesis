...
\begin{figure}[h]
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \textcolor{cyan}{\fboxrule=1.5pt\fboxsep=0pt\fbox{\includegraphics[width=0.8\linewidth]{device/app_screen1}}}
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \textcolor{cyan}{\fboxrule=1.5pt\fboxsep=0pt\fbox{\includegraphics[width=0.8\linewidth]{device/app_screen2}}}
...
\textit{MathWorks MATLAB 2021a}~\cite{MATLAB} s pomocí \textit{Signal Processing
    Toolboxu}~\cite{matlabSPT}. Jednotlivé části zpracování jsou rozebrány v
...
funkce \texttt{conv(u,v)}~\cite{matlabCONV}. Konvoluční jádro je tvořen podílem
...
\begin{figure}[h]
    \begin{center}
        \includegraphics[width=0.8\textwidth]{diagrams/fixpeaks}
...
Vzhledem k tomu, že při srdeční frekvenci 60 bpm se hodnota $mRRs$ pohybuje okolo
...
\begin{figure}[h]
    ...
    \begin{center}
        \includegraphics[width=1\textwidth]{diagrams/rr_decision}
        \caption{Diagram zobrazuje rozhodovací část algoritmu pro všechny R-R intervaly takové, že $|dRRs_j| > 1$. 
        Každý interval může splnit právě jednu podmínku reprezentovanou listy diagramu.
        Pokud R-R interval nevyhovuje ani jednomu kritériu, je klasifikován jako normální~\cite{Lipponen2019}.}
...
\begin{figure}[h]
    ...
    \begin{subfigure}[t]{0.3\textwidth}
        \centering
        \textcolor{cyan}{\fboxrule=0.5pt\fboxsep=0pt\fbox{\includegraphics[width=1.05\linewidth]{bbpm/settings_general}}}
    ...
    \begin{subfigure}[t]{0.3\textwidth}
        \centering
        \textcolor{cyan}{\fboxrule=0.5pt\fboxsep=0pt\fbox{\includegraphics[width=1.05\linewidth]{bbpm/settings_graph}}}
    ...
    \begin{subfigure}[t]{0.3\textwidth}
        \centering
        \textcolor{cyan}{\fboxrule=0.5pt\fboxsep=0pt\fbox{\includegraphics[width=1.05\linewidth]{bbpm/settings_recording}}}
