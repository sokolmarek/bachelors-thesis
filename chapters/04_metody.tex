...
\begin{figure}[h]
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \textcolor{cyan}{\fboxrule=2pt\fboxsep=0pt\fbox{\includegraphics[width=0.8\linewidth]{device/app_screen1}}}
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \textcolor{cyan}{\fboxrule=2pt\fboxsep=0pt\fbox{\includegraphics[width=0.8\linewidth]{device/app_screen2}}}
...
\begin{figure}[h]
    \begin{center}
        \includegraphics[width=0.65\textwidth]{figures/my_poincare}
...
\begin{figure}[h]
    ...
    \begin{subfigure}[b]{0.3\textwidth}
        \centering
        \textcolor{cyan}{\fboxrule=0.5pt\fboxsep=0pt\fbox{\includegraphics[width=1.1\linewidth]{bbpm/settings_general}}}
    ...
    \begin{subfigure}[b]{0.3\textwidth}
        \centering
        \textcolor{cyan}{\fboxrule=0.5pt\fboxsep=0pt\fbox{\includegraphics[width=1.1\linewidth]{bbpm/settings_graph}}}
    ...
    \begin{subfigure}[b]{0.3\textwidth}
        \centering
        \textcolor{cyan}{\fboxrule=0.5pt\fboxsep=0pt\fbox{\includegraphics[width=1.1\linewidth]{bbpm/settings_recording}}}
...
Pro zpracování dat jsou využívané integrované funkce prostředí Python a
