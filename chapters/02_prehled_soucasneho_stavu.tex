...
\begin{enumerate}
	...
	\item \textbf{Wilsonovy unipolární hrudní svody (V1 -- V6)} -- sestávají z
	      ...
	      \begin{figure}[h]
		      ...
		      [.35\linewidth]{\includegraphics[height=5cm]{anatomy/unipolar2}}
		      \hfill
		      \subcaptionbox{Přiložení unipolárních hrudních svodů podle Wilsona
			      ...
			      [.6\linewidth]{\includegraphics[height=4cm]{anatomy/unipolar3}}
...
\begin{figure}[h]
	\begin{center}
		\includegraphics[width=0.5\textwidth]{figures/wiki_poincare}
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[width=0.9\textwidth]{diagrams/nvi}
