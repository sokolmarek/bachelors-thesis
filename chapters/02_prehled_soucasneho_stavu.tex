...
\cite{Jan2002}. Stabilita filtrů vychází z-transformace impulzní odezvy:
...
\cite{PrPrchal2000,Jan2002}. Níže jsou další vybrané vlastnosti IIR filtrů
\cite{Jan2002}:
...
v \cite{Alvarez2013,Kohler2002,Canento2012,Karpagachelvi2010,Vaneghi2012}.
...
Jak již vyplývá z předešlého odstavce, variabilita srdeční frekvence je časová
variace mezi jednotilvými stahy srdce, která se v rámci naměřeného EKG záznamu
musí vypočítat, stejně jako parametry z ní vycházející. Výpočet a smysl
specifických parametrů už spadá pod jednotlivé metody hodnocení HRV v
následující kapitole. K tomu aby bylo možné HRV kvantitativně hodnotit je
...
\subsubsection{Aplikace HRV v diagnostice a terapii}
