...
frekvenční charakteristiky. Na Obr. \ref{filters_comparison} jsou graficky
znázorněny tyto charektaristiky pro FIR filtr 15. řádu a Čebyševův filtr 5. řádu
...
filtru, který jich vyžadoval 15. Hlavní rozdíl vyplivá především z fázové
...
rušivých složek přicházi na řadu jeho segmentace a extrace komponentů potřebných
...
\subsubsection{Detekce a extrakce EKG komponentů}
