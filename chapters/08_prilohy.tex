...
\includepdf[pages=1,pagecommand={},scale=.75,offset=.5cm 0]{potvrzeni_eticke_komise}
...
\label{att:data}
\addcontentsline{toc}{section}{Příloha D: Obsah přiloženého ZIP souboru}
...
\begin{figure}[h]
    \begin{minipage}{0.95\textwidth}
        \dirtree{%
            ...
            .3 keywords\_cs.txt\DTcomment{Klíčová slova v ČJ}.
            .3 keywords\_en.txt\DTcomment{Klíčová slova v AJ}.
