...
\begin{figure}[h]
    \dirtree{%
        .1 src.
        .2 filters.m\DTcomment{Navržené digitální filtry}.
        .2 QRSDetectors\DTcomment{MATLAB implementace QRS detektorů}.
        .3 pan\_tompkins.m.
        .3 hamilton\_tompkins.m.
        .3 nabian.m.
        .2 ECGDataAnalyzer.mlapp\DTcomment{Navržená MATLAB aplikace}.
        .2 BBPM\DTcomment{Zdrojový kód Python aplikace \textit{BBPM}}.
        .2 thesis\DTcomment{Zdrojový kód bakalářské práce ve formátu \LaTeX{}}.
        .1 text\DTcomment{Thesis text}.
        .2 assignment.pdf\DTcomment{Zadání bakalářské práce v PDF formátu}.
        .2 17PBBBP\_483417\_Marek\_Sokol.pdf\DTcomment{Bakalářská práce v PDF formátu}.
    }
\end{figure}
