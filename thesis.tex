...
\documentclass[a4paper,12pt,czech]{article}   % Definice - velikost dokumentu, základní velikost písma, typ
...
\usepackage[linesnumbered,czech,onelanguage]{algorithm2e}
\SetAlgoCaptionLayout{centerline}
\SetKwInput{KwVstup}{Vstup}%
\SetKwInput{KwVystup}{V\'ystup}%
...
\includepdf[pages=-,scale=.75,trim=1mm 1mm 6mm 1mm,pagecommand={},offset=.5cm 0, clip]{assignment/assignment_colored}
...
\section*{ABSTRAKT}
\subsection*{\nazev:}
\input{chapters/abstract_cz.tex}
...
\input{chapters/00_seznam_symbolu_a_zkratek}
\clearpage
